...
namespace TheLight.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/Bundles/DataTables";
        private const string CSharpCodePath = "Assets/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/Bundles/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "TheLight");
