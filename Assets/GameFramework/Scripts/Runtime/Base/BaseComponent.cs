...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        private void InitZipHelper()
        {
            ...
            Utility.Compression.ICompressionHelper zipHelper = (Utility.Compression.ICompressionHelper)Activator.CreateInstance(zipHelperType);
            if (zipHelper == null)
            {
            ...
            Utility.Compression.SetCompressionHelper(zipHelper);
        }
